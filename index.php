<!-- This login form for MOFH has been created by VizuDev. More info at https://vizudev.net/ -->
<!DOCTYPE html>
					...
					<div id="content-container">
						<div id="login-container">
							<div id="login-sub-container">
								...
								<div id="login-sub">
									<div id="clickthrough_form" style="visibility:hidden"></div>
									<div id="forms">
										<form novalidate id="login_form" action="
											<?php include("urlhosting.php");?>/login.php" method="post" style="visibility:">
